></div>";<?php
  ...
  try
  {
    ...
    $mail->Body = "<div dir='ltr' lang='en'>Hello {$_POST['firstname']} {$_POST['lastname']},<br/><br/>You are now checked in with Jet Aviation.<br/><br/>Attached is your personalized QR code.<br/><br/>Please scan the code to start building your personal service itinerary.<br/><br/>We'll do our best to make sure the rest of your journey is <i>effortless.</i><br/><br/>Kind regards,<br/>The Jet Aviation Team.<br/></div><div><img src='cid:qrpng' alt='' /><br/><br/></div>";
    $mail->send();
  }
  catch (Exception $e)
  {
