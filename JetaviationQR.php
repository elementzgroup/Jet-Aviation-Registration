></div>";<?php
  ...
  try
  {
    ...
    $dbq = $db->prepare("INSERT INTO `users` (firstname,lastname,email,company,jobTitle,industry,receiveInfo,regdate) VALUES (:firstname,:lastname,:email,:company,:jobTitle,:industry,:receiveInfo,:regdate);");
  ...
  try
  {
    ...
    $mail->addReplyTo("noreply@elementz.live", "Jet Aviation");
    $mail->isHTML(true);
